...
-- ─── routes ──────────────────────────────────────────────────────────────────
-- The route catalog comes from local KML track exports, not mock data.
-- Rebuild it with scripts/import-hiking-routes.mjs + the generated migration
-- (supabase/migrations/20260917140000_import_hiking_routes.sql).
...
insert into journeys (id, user_id, route_id, name, region, coord, lng, lat, dist, asc_, tone, "desc", date, days, planned_date, countdown, day_index, total_days, fav) values
  ...
  ('m2', uid, null, '武功山三日穿越', '江西 · 萍乡', '27.46 N · 114.17 E', 114.17, 27.46, '24.6 km', '+1,640 m', 'ridge', '正走在金顶到发云界的草甸上，昨夜扎营看到了完整的银河。今天目标是绝望坡前的营地。', '记录到 Day 2/3', '3 天', null, null, 2, 3, false),
  ('m3', uid, null, '贡嘎西坡转山', '四川 · 甘孜', '29.59 N · 101.88 E', 101.88, 29.59, '38.4 km', '+2,980 m', 'snow', '翻越日乌且垭口那天遇到了完美的日照金山。五天高海拔重装，是迄今最难也最难忘的一段。', '2025 · 10 月', '5 天', null, null, null, 5, true),
  ('m4', uid, null, '雨崩神瀑', '云南 · 德钦', '28.40 N · 98.85 E', 98.85, 28.4, '14.2 km', '+760 m', 'river', '从西当温泉一路走到神瀑，雨季的森林格外通透。住在雨崩下村，慢悠悠走了四天。', '2025 · 5 月', '4 天', null, null, null, 4, false),
  ('m5', uid, null, '哈巴雪山大本营', '云南 · 香格里拉', '27.36 N · 100.10 E', 100.1, 27.36, '9.8 km', '+980 m', 'moss', '独行的一次适应性徒步，从哈巴村慢慢爬到大本营。云海在脚下翻涌，安静得只剩风声。', '2024 · 11 月', '2 天', null, null, null, 2, false)
